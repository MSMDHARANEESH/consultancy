...
const userDB = mongoose.createConnection('mongodb+srv://dharaneesh:1234abcd@cluster0.elsoubt.mongodb.net/user?retryWrites=true&w=majority', {
...
const productDB = mongoose.createConnection('mongodb+srv://dharaneesh:1234abcd@cluster0.elsoubt.mongodb.net/', {
  useNewUrlParser: true,
  useUnifiedTopology: true,
});
